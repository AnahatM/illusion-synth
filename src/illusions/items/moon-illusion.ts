...
const moonIllusion: IllusionConfig = {
  ...
  setup(scene, _camera, params) {
    material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uMoonColor: { value: hexToVec3(params.moonColor as string) },
        uSkyColor: { value: hexToVec3(params.skyColor as string) },
      },
    });
  ...
  update(_time, params) {
    ...
    material.uniforms.uMoonColor.value = hexToVec3(params.moonColor as string);
    material.uniforms.uSkyColor.value = hexToVec3(params.skyColor as string);
  },
