...
- [ ] Munker Illusion
- [ ] Kinetic depth fails at equiluminance
- [ ] Loss of contour in colour
- [ ] Gestalt loss in equiluminance
- [ ] Equiluminance (flicker fusion & minimum motion)
- [ ] Colour mixing (additive and multiplicative)
- [ ] Colour matching (game)
- [ ] Colour Phi
- [ ] The Dress
- [ ] Red Strawberries that are not red
...
- [ ] Hidden message (blur & figure-ground)
- [ ] Blur in diamonds vs. squares illusion
- [ ] Blotted letters (Gestalt completion)
- [ ] Hidden Figure (Dalmatian Dog)
- [ ] Hidden Bird
- [ ] Hidden object in brick wall
- [ ] Rotation changes interpretation
